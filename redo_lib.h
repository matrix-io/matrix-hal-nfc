...
/**
 * Header for hardware configuration: bus interface, reset of attached reader
 * ID, onboard LED handling etc.
 * */
...
#include <phpalI14443p4a.h>
/*
 * Generic MIFARE(R) Ultralight Application Component of Reader Library
 * Framework
 */
#include <phalMfc.h>
#include <phalMful.h>
...
typedef struct {
  ...
  phhalHw_Nfc_Ic_DataParams_t
      sHal_Nfc_Ic; /* HAL component holder for Nfc Ic's */
  ...
  phpalI14443p4a_Sw_DataParams_t
      spalI14443p4a; /* PAL ISO I14443-4A component */
